...
import { ChartBarIcon, ChevronDownIcon, CursorArrowRaysIcon, ShieldCheckIcon, XMarkIcon } from '@heroicons/react/20/solid'
...
const callsToAction = [
  { name: 'Watch Demo', href: '#', icon: CursorArrowRaysIcon },
  { name: 'View All Products', href: '#', icon: CursorArrowRaysIcon },
  { name: 'Contact Sales', href: '#', icon: CursorArrowRaysIcon },
]
const company = [
  { name: 'About', href: '#', icon: CursorArrowRaysIcon },
  { name: 'Customers', href: '#', icon: CursorArrowRaysIcon },
  { name: 'Press', href: '#', icon: CursorArrowRaysIcon },
  { name: 'Careers', href: '#', icon: CursorArrowRaysIcon },
  { name: 'Privacy', href: '#', icon: CursorArrowRaysIcon },
]
const resources = [
  { name: 'Community', href: '#', icon: CursorArrowRaysIcon },
  { name: 'Partners', href: '#', icon: CursorArrowRaysIcon },
                            ...
                            >
                              <div className="flex md:h-full lg:flex-col">
                                <div className="flex-shrink-0">
                                  <span className="inline-flex items-center justify-center h-10 w-10 rounded-md bg-sky-500 text-white sm:h-12 sm:w-12">
